...
app.use(express.static('dist')) // 托管vue打包后的静态文件
...
app.get("/user1", function(req, res, next) {
    // res.sendFile("E:/myProject/ws/dist/index.html"); // 成功但都是user1
    res.sendFile(__dirname+"/views/user1.html"); // 不设 header为 json可以在局域网聊天 都是user1
})
